...
#include<stdio.h>
 #include <string.h>
 struct cricket { char name [100]; char team_name[100]; int batting_average; }; 
void main() 
{ 
struct cricket player[200]; 
int i,n; char ch,team[100];
...
OUTPUT:it has been verified but i dont know how to take the screenshot and upload it. the code is similar to what u have explained
